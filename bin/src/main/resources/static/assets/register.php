...
if(trim($name_register) == '') {
	...
	exit();
} else if(trim($portfolio ) == '') {
	echo '<div class="error_message">Please enter your portfolio.</div>';
	exit();
...
$usermessage = "Thank you for submit your restaraunt to MAGELLANO. We will reply shortly with more details!";
